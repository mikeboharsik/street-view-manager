...
export default function globalReducer(state, action) {
	...
	switch (actionType) {
		...
		case ACTIONS.DELETE_PHOTOS: {
			...
			const newThumbnails = { ...state.uploads.thumbnails };
			...
			const newUploads = { ...state.uploads, photos: newPhotos, thumbnails: newThumbnails };
		...
		case ACTIONS.SORT_PHOTOS: {
			const { reverse, sortFunc, sortProp = 'uploadTime' } = payload;
